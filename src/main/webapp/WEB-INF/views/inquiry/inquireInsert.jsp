...
<!--                         <p class="member1"><a href="#">고객센터</a></p> -->
<!--                     </div> -->
<!--                     <div id="headlayer"> -->
...
<!--             </header> -->
            <main class="contents">
                ...
                <div id="board_write">
                    ...
                    <hr><br>
                        <div id="write_area">
                            <form action="/inquiry/iinsert.do" method="post">
                            	<div id="in_title">
                                ...
                                <div id="in_content">
                                    <p>내용<b>*</b></p><textarea name="content" id="ucontent" placeholder="내용을 입력해주세요." required></textarea>
                                </div>
